...
public abstract class BaseDAOImpl<T extends BaseDTO> implements BaseDAOInt<T> {
	...
	public T findByPK(long pk, UserContext userContext) {
		System.out.println("in basedao findbypk start..");
	...
	protected TypedQuery<T> createCriteria(T dto, UserContext userContext) {
		...
		System.out.println(" isgroup skipped......Rajat");
		cq.where(whereClause.toArray(new Predicate[whereClause.size()]));

		List<Order> orderBys = getOrderByClause(dto, builder, qRoot);

		System.out.println("after getOrder By clause........Rajat");
		cq.orderBy(orderBys.toArray(new Order[orderBys.size()]));

		System.out.println("After order by clause.......Rajat ");
		TypedQuery<T> query = entityManager.createQuery(cq);
		System.out.println("createCriteria end here---....Rajat");
		return query;
	...
	public long add(T dto, UserContext userContext) {
		...
		System.out.println("before calling persist method in base dao......rajat");
		entityManager.persist(dto);
		System.out.println("after calling persist method in base dao dto id is.... " + dto.getId() );
		return dto.getId();
	...
	public void delete(T dto, UserContext userContext) {
		System.out.println("in basedao impl delete start..");
	...
	protected List<Order> getOrderByClause(T dto, CriteriaBuilder builder, Root<T> qRoot) {
		...
		System.out.println("baseDAO in getOrderByClause.......Rajat ");
