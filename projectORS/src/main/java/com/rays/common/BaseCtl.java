...
public abstract class BaseCtl<F extends BaseForm, T extends BaseDTO, S extends BaseServiceInt<T>> {
	...
	public ORSResponse get(@PathVariable long id) {
		...
		System.out.println("BaseCtl Get() method run.......Rajat");
	...
	public ORSResponse deleteMany(@PathVariable String[] ids, @RequestParam("pageNo") String pageNo,
			@RequestBody F form) {
		System.out.println("BaseCtl DeleteMany() method....Rajat... run");
		ORSResponse res = new ORSResponse(true);
		try {
			...
			System.out.println("Records Deleted Successfully by Rajat");
	...
	public ORSResponse save(@RequestBody @Valid F form, BindingResult bindingResult) {
		System.out.println("save() run in BaseCtl :: Rajat " + form);
	 ...
	 * @return ORSResponse
	 */
	protected ORSResponse success(String message, Object data) {
		ORSResponse res = new ORSResponse(true);
	 ...
	 * @return ORSResponse
	 */
	protected ORSResponse fail(String message) {
